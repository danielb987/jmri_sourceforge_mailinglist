...
public class JFrame_MainWindow extends javax.swing.JFrame {
    ...
    public void download() {
        try {
            DownloadJMRI downloadJMRI = new DownloadJMRI(this);
            downloadJMRI.download();
        } catch (FileNotFoundException | UnsupportedEncodingException | KeyManagementException | NoSuchAlgorithmException ex) {
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                JFrame_MainWindow mainWindow = new JFrame_MainWindow();
